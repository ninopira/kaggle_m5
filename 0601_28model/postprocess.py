...
for num in ['1st', '2nd', '3rd']:
    ...
    valid_preds.to_csv(f'./result/rm_ch_apply_cate_be_af_rm_zero/concat_val_{num}_{wrmsse_score}.csv', index=False)
...
for num in ['1st', '2nd', '3rd']:
    ...
    plt.savefig(f'./result/rm_ch_apply_cate_be_af_rm_zero/sub_{num}_WRMSSE_{wrmsse_score_dict[num]}.png')
    ...
    result_dir = f'./result/rm_ch_apply_cate_be_af_rm_zero/'
