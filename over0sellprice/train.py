...
result_dir = './result/set_seed/shop_no_price_again_add_4weekdays_stat_std_shop_cumsum_zerodem_encho_rmse/'
...
f_paths = [
    './feature/custom_feature/f_hold_out_mean_encoding_df.pkl',
