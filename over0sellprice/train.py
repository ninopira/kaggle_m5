...
result_dir = './result/set_seed/baseline_shop_no_price_again_add_4weekdays_stat_std_shop_cumsum_zerodem_m_s_dem_shop_std_no_roll/'
...
f_paths = [
    './feature/zero_demand/f_id_zero_demand_mean_std.pkl',
