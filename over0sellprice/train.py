...
result_dir = './result/set_seed/baseline_shop_no_price_again_add_4weekdays_stat_std_shop_cumsum_zerodem_lagdiv/'
...
f_paths = [
    './feature/lag_demand/f_id_lag_demand_diif_dev.pkl',
