...
for num in ['1st', '2nd']:
    ...
    for days in range(1, 29):
        print('days', days)
        result_dir = f'./result/28model/no_price_shop_cumsum_zerodem_dem_shop_std_week_trend_4weekstat_more_lag_rm-ch_cate/day{days}'
    ...
    df_vals.to_pickle(f'./result/28model/no_price_shop_cumsum_zerodem_dem_shop_std_week_trend_4weekstat_more_lag_rm-ch_cate/val_all_{num}.pkl')
...
result_dir = f'./result/28model/no_price_shop_cumsum_zerodem_dem_shop_std_week_trend_4weekstat_more_lag_rm-ch_cate/'
