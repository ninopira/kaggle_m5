...
result_dir = './result/set_seed/baseline_shop_no_price_again_add_4weekdays_stat_std_shop_cumsum_zerodem_dem_shop_no_roll_std/'
...
f_paths = [
    './feature/shop/f_devine_ave_lag28demand_day_store_dept.pkl',
